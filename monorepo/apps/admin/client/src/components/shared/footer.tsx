...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-white border-t py-4 px-6 flex flex-col md:flex-row items-center justify-between text-sm text-gray-600 mt-4">
      <div className="mb-2 md:mb-0">
        <span>Contact: </span>
        <a href="mailto:support@tiyende.com" className="underline hover:text-blue-600">support@tiyende.com</a>
        <span className="ml-4">Phone: <a href="tel:+260123456789" className="underline hover:text-blue-600">+260 123 456 789</a></span>
      </div>
      <div className="flex space-x-4">
        <a href="https://facebook.com/tiyende" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-blue-600">
